package ksnoop_file_permissions
...
//go:generate go run github.com/cilium/ebpf/cmd/bpf2go -type event bpf ./file_permissions.bpf.c -- -I../headers

func FilePermissions(ctx context.Context) {
	...
	// Link tracepoints
	tpEnterLink, err := link.Tracepoint("syscalls", "sys_enter_chmod", objs.FilePermissions, nil)
	if err != nil {
